...
public class Acte {
	...
	public void setNbrActeNaissance(long nbrActeNaissance) {
		this.nbrActeNaissance = nbrActeNaissance;
	}

	public long getNbrActeDeces() {
		return nbrActeDeces;
	}

	public void setNbrActeDeces(long nbrActeDeces) {
		this.nbrActeDeces = nbrActeDeces;
	}

	public long getNbrActeMariage() {
		return nbrActeMariage;
	}
